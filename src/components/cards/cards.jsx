...
<div className="pt-4 text-gray-500">
  ...
  <label tabIndex={0} className="btn m-1">More Info</label>
  <div tabIndex={0} className="dropdown-content card card-compact w-64 p-2 shadow bg-bulei text-bulei-content">
